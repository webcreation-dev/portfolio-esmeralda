        ...
        <div class="col-lg-12 m-auto">
          ...
          <div class="row">
            ...
            <div class="col-lg-6" data-aos="fade-right" data-aos-duration="1000">
              <div class="images-area2">
                <div class="img1">
                  <a href="index4.php" target="_blank">
                    <video muted="" autoplay="" loop="">
                ...
                <div class="btn-area1">
                  <a href="index4.php" target="_blank" class="vl-btn1 m-0">VIEW DEMO</a>
                </div>
                <div class="space32"></div>
                <div class="text text-center">
                  <a href="index4.php" target="_blank">Noise Effect</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-6" data-aos="fade-right" data-aos-duration="1000">
              <div class="images-area2">
                <div class="img1">
                  <a href="index6.php" target="_blank">
                    <video muted="" autoplay="" loop="">
                ...
                <div class="btn-area1">
                  <a href="index6.php" target="_blank" class="vl-btn1 m-0">VIEW DEMO</a>
                </div>
                <div class="space32"></div>
                <div class="text text-center">
                  <a href="index6.php" target="_blank">Earth Line Sphere</a>
                </div>
              </div>
            </div>
